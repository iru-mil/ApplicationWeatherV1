...
class FavoritesDetailsService(name: String = "FavoritesDetailService") : IntentService(name) {
    ...
    private fun onSuccessResponse(
        ...
        broadcastIntent.putExtra(DETAILS_WIND_DIR_EXTRA, windDir)
        broadcastIntent.putExtra(DETAILS_HUMIDITY_EXTRA, humidity)
        broadcastIntent.putExtra(DETAILS_ICON_EXTRA, icon)
